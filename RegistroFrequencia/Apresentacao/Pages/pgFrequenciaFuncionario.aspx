<%@ Page Title="SISFREQ - Consultar Frequência" Language="C#" MasterPageFile="~/Layouts/MPInterna.master" AutoEventWireup="true" CodeBehind="pgFrequenciaFuncionario.aspx.cs" Inherits="Apresentacao.Pages.Gerente.pgFrequenciaFuncionario" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder4" runat="server">
    ...
    <div>
        <asp:Panel runat="server" ID="panelListaPontos" GroupingText="Pontos" Visible="false">
            ...
            <div class="row">
                <div class="col-sm-2 col-md-2 col-xs-2 col-lg-2 col-lg-offset-5 col-sm-offset-5 col-md-offset-5 col-xs-offset-5">
    ...
    <asp:Panel ID="panelListaFrequencia" runat="server" GroupingText="Lista de Frequencia">
        ...
        <div class="form-group">
            <div class="form-group">
                <label class="control-label col-sm-2 col-md-2 col-lg-2 col-xs-2 col-sm-offset-1 col-md-offset-1 col-lg-offset-1 col-xs-offset-1 col-lg-offset-1">Funcionário</label>
                <div class="col-sm-6 col-md-6 col-lg-6 col-xs-6">
                    <asp:DropDownList ID="ddlFuncionarios" CssClass="form-control" runat="server"></asp:DropDownList>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2 col-md-2 col-lg-2 col-xs-2 col-sm-offset-1 col-md-offset-1 col-lg-offset-1 col-xs-offset-1 col-lg-offset-1">Período</label>
            ...
            <div class="form-group ">
                <div class="col-sm-offset-5 col-md-offset-5 col-lg-offset-5 col-xs-offset-5 col-lg-offset-5">
                    <asp:Button ID="btnMostrar" CssClass="btn btn-primary" OnClick="btnMostrar_Click" runat="server" Text="Mostrar" />
                    <asp:Button ID="btnRelatorio" CssClass="btn btn-default" OnClick="btnRelatorio_Click" runat="server" Text="Relatorio de Frequência" />
                </div>
            </div>
        </div>
